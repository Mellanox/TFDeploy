...
class TestEnvironment(object):
    ...
    def __init__(self):
        ...
        self._hostname_by_ip = { "192.168.1.41": "clx-mld-41",
    ...
    def getHostname(self, ip):
        if ip in self._hostname_by_ip:
            return self._hostname_by_ip[ip]
        return ip
    
    # -------------------------------------------------------------------- #
    
    def getHostnames(self, ips):
        return [self.getHostname(ip) for ip in ips]
